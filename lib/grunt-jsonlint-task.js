 ...
 */
exports = module.exports = function makeTask(grunt, jsonlint, strip, validator, sorter) {
  var FORMATTERS = {
        ...
        this.filesSrc.forEach(function (file) {
          ...
          try {
            ...
            if (schema.src) {
              ...
              var validate = validator.compile(parsedSchema, schema.environment);
              validate(parsedData);
            }
            ...
            if ( options.format ) {
              ...
              var fmtd = JSON.stringify( parsedData, null, options.indent ) + "\n";
